...
% HT Algorithm for solving 2 laplacian 4d diffusion eqn w/ 3rd order
% accuracy
%---------------------
...
for p = 1:length(lambdavec)
 %HTucker Decomp u0
    ...
    for n = 2:Nt 
        ...
        %% Step 1      
        %Stage 1 sol(t(k=1)) = sol(tn)+dt*nu*D(sol(t(k=1))
        ...
        K2_k2 = ( U2_n*tens2mat(Btil12_n,2)*kron( B34matcT_n'*kron(U4_n'*U4star_k2,U3_n'*U3star_k2)*B34starmatcT_k2 , U1_n'*U1star_k2) ...
                    + dtn*(1-nu)/2 * (U2_k1*tens2mat(Btil12_k1,2) * kron(B34matcT_k1'*kron(U4_k1'*U4star_k2,    U3_k1' *U3star_k2)*B34starmatcT_k2, (F1*U1_k1)'*U1star_k2) + ...
        ...
        K4_k2 = ( U4_n * tens2mat(Btil34_n,2) * kron( B12matcT_n'*kron(U2_n'*U2star_k2,U1_n'*U1star_k2)*B12starmatcT_k2 , U3_n'*U3star_k2) ...
                  + dtn*(1-nu)/2 * (U4_k1 * tens2mat(Btil34_k1,2) * kron(B12matcT_k1'*kron(U2_k1'*U2star_k2,U1_k1'*     U1star_k2)*B12starmatcT_k2, (F3*U3_k1)'*U3star_k2) + ...
        ...
        B =   ttm(Btil12_n,  {               U1hat_k2'*   U1_n,  U2hat_k2'* U2_n,  B34starmatcT_k2' * kron(                U3star_k2'*   U3_n,  U4star_k2'*U4_n)  * B34matcT_n}, [1,2,3])+...
            ( ttm(Btil12_k1, {               U1hat_k2'*   U1_k1, U2hat_k2'* U2_k1, B34starmatcT_k2' * kron( dtn*(1-nu)/2 * U3star_k2'*F3*U3_k1, U4star_k2'*U4_k1) * B34matcT_k1},[1,2,3])+...
              ttm(Btil12_k1, {dtn*(1-nu)/2 * U1hat_k2'*F1*U1_k1, U2hat_k2'* U2_k1, B34starmatcT_k2' * kron(                U3star_k2'   *U3_k1, U4star_k2'*U4_k1) * B34matcT_k1},[1,2,3]) ); %r1hatxr2hatxr34
        ...
        B =   ttm(Btil34_n,  {               U3hat_k2'   *U3_n, U4hat_k2'* U4_n, B12starmatcT_k2'  * kron(                U1star_k2'*    U1_n, U2star_k2'*U2_n) * B12matcT_n},[1,2,3])+...
            ( ttm(Btil34_k1, {               U3hat_k2'   *U3_k1, U4hat_k2'* U4_k1, B12starmatcT_k2'* kron( dtn*(1-nu)/2 * U1star_k2'*F1*U1_k1, U2star_k2'*U2_k1) * B12matcT_k1},[1,2,3])+...
              ttm(Btil34_k1, {dtn*(1-nu)/2 * U3hat_k2'*F3*U3_k1, U4hat_k2'* U4_k1, B12starmatcT_k2'* kron(                U1star_k2'   *U1_k1, U2star_k2'*U2_k1) * B12matcT_k1},[1,2,3])); %r1hatxr2hatxr34
        [~,Btil34hat_k2] = Simoncini_V2(M1,A1,H,A2,M,H3,A3,B);        
        [~,~,r34hat_k2] = size(Btil34hat_k2); 
        Btil34hatmat_k2 = tens2mat(Btil34hat_k2,3) ;
        [B34hatmat_k2,~] = qr(Btil34hatmat_k2',0);
        ...
        htaug1 = plus(plus(htn,htk1),htk2);
        htaug1 = truncate_nonorthog(htaug1,opts);

        B1234star_k3 = htaug1.B{1}; 
        B12star_k3 = htaug1.B{2}; 
        B34star_k3 = htaug1.B{3};
        U1star_k3 = htaug1.U{4};
        U2star_k3 = htaug1.U{5};
        U3star_k3 = htaug1.U{6};
        U4star_k3 = htaug1.U{7};
        ...
        K2_k3 = ( U2_n*tens2mat(Btil12_n,2)*kron( B34matcT_n'*kron(U4_n'*U4star_k3,U3_n'*U3star_k3)*B34starmatcT_k3 , U1_n'*U1star_k3) ...
                    + B1*dtn * (U2_k1*tens2mat(Btil12_k1,2) * kron(B34matcT_k1'*kron(U4_k1'*U4star_k3,     U3_k1'*U3star_k3)*B34starmatcT_k3, (F1*U1_k1)'*U1star_k3)+ ...
                                U2_k1*tens2mat(Btil12_k1,2) * kron(B34matcT_k1'*kron(U4_k1'*U4star_k3,(F3*U3_k1)'*U3star_k3)*B34starmatcT_k3,      U1_k1'*U1star_k3) )...
                    + B2*dtn * (U2_k2*tens2mat(Btil12_k2,2) * kron(B34matcT_k2'*kron(U4_k2'*U4star_k3,     U3_k2'*U3star_k3)*B34starmatcT_k3, (F1*U1_k2)'*U1star_k3)+ ...
                                U2_k2*tens2mat(Btil12_k2,2) * kron(B34matcT_k2'*kron(U4_k2'*U4star_k3,(F3*U3_k2)'*U3star_k3)*B34starmatcT_k3,      U1_k2'*U1star_k3) ))/ ...
                    ( speye(r34star_k3*r1star_k3) - ( kron(speye(r34star_k3), dtn*nu*U1star_k3'*F1'*U1star_k3) + ...
                    kron( B34starmatcT_k3'*kron( speye(r4star_k3), dtn*nu*U3star_k3'* F3'* U3star_k3)* B34starmatcT_k3 ,speye(r1star_k3)) ) ) ;
        ...
        K3_k3 = sylvesterf( (speye(N3)-dtn*nu*F3), ...
                    ...
                    + B2*dtn * (F3* U3_k2 * tens2mat(Btil34_k2,1) *   kron( B12matcT_k2'*kron(U2_k2'*U2star_k3,     U1_k2'*U1star_k3)*B12starmatcT_k3,U4_k2'*U4star_k3) ...
                                  + U3_k2 * tens2mat(Btil34_k2,1) *   kron( B12matcT_k2'*kron(U2_k2'*U2star_k3,(F1*U1_k2)'*U1star_k3)*B12starmatcT_k3,U4_k2'*U4star_k3  )));

        K4_k3 = ( U4_n * tens2mat(Btil34_n,2) * kron( B12matcT_n'*kron(U2_n'*U2star_k3,U1_n'*U1star_k3)*B12starmatcT_k3 , U3_n'*U3star_k3) ...
                  + B1*dtn * (U4_k1 * tens2mat(Btil34_k1,2) * kron(B12matcT_k1'*kron(U2_k1'*U2star_k3,U1_k1'     *U1star_k3)*B12starmatcT_k3, (F3*U3_k1)'*U3star_k3)+ ...
                              U4_k1 * tens2mat(Btil34_k1,2) * kron(B12matcT_k1'*kron(U2_k1'*U2star_k3,(F1*U1_k1)'*U1star_k3)*B12starmatcT_k3,     U3_k1'* U3star_k3) )...
                  + B2*dtn * (U4_k2 * tens2mat(Btil34_k2,2) * kron(B12matcT_k2'*kron(U2_k2'*U2star_k3,U1_k2'     *U1star_k3)*B12starmatcT_k3, (F3*U3_k2)'*U3star_k3)+ ...
                              U4_k2 * tens2mat(Btil34_k2,2) * kron(B12matcT_k2'*kron(U2_k2'*U2star_k3,(F1*U1_k2)'*U1star_k3)*B12starmatcT_k3,     U3_k2'* U3star_k3) )) / ...
                 ( speye(r12star_k3*r3star_k3) - ( kron(speye(r12star_k3), dtn*nu*U3star_k3'*F3'*U3star_k3) + ...
                 kron( B12starmatcT_k3'*kron( speye(r2star_k3), dtn*nu*U1star_k3'*F1'*U1star_k3)*B12starmatcT_k3 , speye(r3star_k3)) ) );
       ...
       % B steps (3)
        ...
        A1 = speye(r2hat_k3); 
        H = speye(r1hat_k3); 
        A2 = B34starmatcT_k3'*kron(speye(r4star_k3), -dtn*(nu)* U3star_k3'*(F3*U3star_k3))*B34starmatcT_k3; 
        M = speye(r2hat_k3);
        H3 = speye(r34star_k3);
        ...
        B =   ttm(Btil12_n,  {         U1hat_k3'*   U1_n,  U2hat_k3'* U2_n,  B34starmatcT_k3' * kron(         U3star_k3'   *U3_n,  U4star_k3'*U4_n ) * B34matcT_n },[1,2,3])+...
            ...
            ( ttm(Btil12_k2, {         U1hat_k3'*   U1_k2, U2hat_k3'* U2_k2, B34starmatcT_k3' * kron(B2*dtn * U3star_k3'*F3*U3_k1, U4star_k3'*U4_k2) * B34matcT_k2},[1,2,3])+...
              ttm(Btil12_k2, {B2*dtn * U1hat_k3'*F1*U1_k2, U2hat_k3'* U2_k2, B34starmatcT_k3' * kron(         U3star_k3'   *U3_k1, U4star_k3'*U4_k2) * B34matcT_k2},[1,2,3])); 
        ...
        A1 = speye(r4hat_k3); 
        H = speye(r3hat_k3); 
        A2 = B12starmatcT_k3'*kron(speye(r2star_k3), -dtn*(nu)* U1star_k3'*(F1*U1star_k3))*B12starmatcT_k3;
        M = speye(r4hat_k3);
        H3 = speye(r12star_k3);
        ...
        B =   ttm(Btil34_n,  {         U3hat_k3'*   U3_n,  U4hat_k3'* U4_n,  B12starmatcT_k3'* kron(         U1star_k3'*   U1_n,  U2star_k3'*U2_n)  * B12matcT_n},[1,2,3])+...
            ( ttm(Btil34_k1, {         U3hat_k3'   *U3_k1, U4hat_k3'* U4_k1, B12starmatcT_k3'* kron(B1*dtn * U1star_k3'*F1*U1_k1, U2star_k3'*U2_k1) * B12matcT_k1},[1,2,3])+...
              ...
              ttm(Btil34_k2, {B2*dtn * U3hat_k3'*F3*U3_k2, U4hat_k3'* U4_k2, B12starmatcT_k3'* kron(         U1star_k3'   *U1_k2, U2star_k3'*U2_k2) * B12matcT_k2},[1,2,3])); %r1hatxr2hatxr34
        ...
        % B1234 equation
        B1234hat_k3 = sylvesterf( speye(r34hat_k3) - B12hatmat_k3'*kron(speye(r2hat_k3) , dtn*nu*U1hat_k3'*(F1*U1hat_k3))*B12hatmat_k3 ,...
            -dtn*nu*B34hatmat_k3'*kron(speye(r4hat_k3),((F3*U3hat_k3)'*U3hat_k3))*B34hatmat_k3 ,...
...
loglog(lambdavec,lambdavec.^3*.002, 'k', LineWidth=1.5)
title("Error test")
xlabel('$\lambda =  \Delta t \Big({1/\mathrm{dx}_1 + 1/\mathrm{dx}_2 + 1/\mathrm{dx}_3 + 1/\mathrm{dx}_4}\Big)$', ...
       'Interpreter','latex', FontSize=13);
ylabel("L1 Norm of Difference from Exact Solution ",FontSize = 13)
legend("Error Using Algorithm", "Slope 3$", Interpreter ='Latex',Location = 'best',FontSize = 13)
