...
%  HT Algorithm for 4D diffusion eqn w/ 2nd order accuracy
%---------------------
...
for p = 1:length(lambdavec)
 %HTucker Decomp u0
    ...
    for n = 2:Nt 
        ...
        [K1_k1,K2_k1,K3_k1,K4_k1] = Kupfull(dtn*nu, N1,N2,N3,N4,r1star_k1,r2star_k1,r3star_k1,r4star_k1,r12star_k1,r34star_k1,F1,F2,F3,F4,U1_n,U2_n,U3_n,U4_n,U1star_k1,U2star_k1,U3star_k1,U4star_k1,B12_n,B34_n,B12starmatcT_k1,B34starmatcT_k1,Btil12_n,Btil34_n);
        ...
        [r12hat_k1,B12hatmat_nn_ddag] = Bupfull(dtn*nu,r1hat_k1,r2hat_k1,r34star_k1,r3star_k1,r4star_k1,F1,F2,F3,F4,U1_n,U2_n,U3_n,U4_n,U1hat_k1,U2hat_k1, U3star_k1, U4star_k1, B34_n,B34starmatcT_k1,Btil12_n);
        ...
        B12hat_k1 = reshape(B12hatmat_nn_ddag, [r1hat_k1,r2hat_k1,r12hat_k1]);
        B34hat_k1 = reshape(B34hatmat_k1, [r3hat_k1,r4hat_k1,r34hat_k1]);


        % B1234 equation

        A =  speye(r34hat_k1) - (B12hatmat_nn_ddag'*kron(dtn*nu*speye(r2hat_k1),U1hat_k1'*(F1*U1hat_k1))*B12hatmat_nn_ddag+...
                                 B12hatmat_nn_ddag'*kron(dtn*nu*U2hat_k1'*(F2*U2hat_k1),speye(r1hat_k1))*B12hatmat_nn_ddag);
        ...
        B1234hat_k1 = sylvesterf(A, B ,...
            B12hatmat_nn_ddag'*kron(U2hat_k1'*U2_n,U1hat_k1'*U1_n)*B12matcT_n*B1234_n*B34matcT_n'*kron(U4_n'*U4hat_k1,U3_n'*U3hat_k1)*B34hatmat_k1 );
        ...
        [K1_nn_ddag,K2_nn_ddag,K3_nn_ddag,K4_nn_ddag] = Kupfull(dtn, N1,N2,N3,N4,r1_n,r2_n,r3_n,r4_n,r12_n,r34_n,F1,F2,F3,F4,U1_n,U2_n,U3_n,U4_n,U1_n,U2_n,U3_n,U4_n,B12_n,B34_n,B12matcT_n,B34matcT_n,Btil12_n,Btil34_n);
        ...
        Unns_ddag = {[],[],[],full(U1hat_k1),full(U2hat_k1),full(U3hat_k1),full(U4hat_k1)};
        Bnns_ddag = {full(B1234hat_k1),full(B12hat_k1),full(B34hat_k1),[],[],[],[]};

        htk2_ddag = htensor(ht_u0.children,ht_u0.dim2ind,Unns_ddag,Bnns_ddag);

        %% k2 prediction matrices
       ...
       K2_k2 = sylvesterf( (speye(N2)-dtn*nu*F2), ...
                   ...
                   + dtn*(1-nu) * (F2* U2_k1 * tens2mat(Btil12_k1,2) * kron( B34matcT_k1'*kron(U4_k1'*U4star_k2,U3_k1'*U3star_k2)     *B34starmatcT_k2,     U1_k1'*U1star_k2 ) ...
        ...
        K4_k2 = sylvesterf( (speye(N4)-dtn*nu*F4), ...
                   ...
                   + dtn*(1-nu) * (F4* U4_k1 * tens2mat(Btil34_k1,2) * kron( B12matcT_k1'*kron(U2_k1'*U2star_k2, U1_k1'*U1star_k2)     *B12starmatcT_k2,     U3_k1' *U3star_k2 ) ...
        ...
        B =   ttm(Btil12_n, {U1hat_k2'*U1_n, U2hat_k2'* U2_n, B34starmatcT_k2' * kron( U3star_k2'*U3_n, U4star_k2'*U4_n) * B34matcT_n},[1,2,3])+...
            ( ttm(Btil12_k1, {             U1hat_k2'*   U1_k1, U2hat_k2'*   U2_k1, B34starmatcT_k2' * kron(dtn*(1-nu) * U3star_k2'*F3*U3_k1, U4star_k2'   *U4_k1) * B34matcT_k1},[1,2,3])+...
              ttm(Btil12_k1, {dtn*(1-nu) * U1hat_k2'*F1*U1_k1, U2hat_k2'*   U2_k1, B34starmatcT_k2' * kron(             U3star_k2'   *U3_k1, U4star_k2'   *U4_k1) * B34matcT_k1},[1,2,3])+ ...
              ttm(Btil12_k1, {             U1hat_k2'*   U1_k1, U2hat_k2'*   U2_k1, B34starmatcT_k2' * kron(dtn*(1-nu) * U3star_k2'   *U3_k1, U4star_k2'*F4*U4_k1) * B34matcT_k1},[1,2,3])+...
              ttm(Btil12_k1, {dtn*(1-nu) * U1hat_k2'*   U1_k1, U2hat_k2'*F2*U2_k1, B34starmatcT_k2' * kron(             U3star_k2'   *U3_k1, U4star_k2'   *U4_k1) * B34matcT_k1},[1,2,3])); %r1hatxr2hatxr34
        ...
        B =   ttm(Btil34_n,  {U3hat_k2'*U3_n, U4hat_k2'* U4_n, B12starmatcT_k2' * kron( U1star_k2'*U1_n, U2star_k2'*U2_n) * B12matcT_n},[1,2,3])+...
            ( ttm(Btil34_k1, {             U3hat_k2'   *U3_k1, U4hat_k2'*   U4_k1, B12starmatcT_k2'* kron( dtn*(1-nu) * U1star_k2'*F1*U1_k1, U2star_k2'*   U2_k1) * B12matcT_k1},[1,2,3])+...
              ttm(Btil34_k1, {dtn*(1-nu) * U3hat_k2'*F3*U3_k1, U4hat_k2'*   U4_k1, B12starmatcT_k2'* kron(              U1star_k2'   *U1_k1, U2star_k2'*   U2_k1) * B12matcT_k1},[1,2,3])+...
              ttm(Btil34_k1, {             U3hat_k2'   *U3_k1, U4hat_k2'*   U4_k1, B12starmatcT_k2'* kron( dtn*(1-nu) * U1star_k2'   *U1_k1, U2star_k2'*F2*U2_k1) * B12matcT_k1},[1,2,3])+...
              ttm(Btil34_k1, {dtn*(1-nu) * U3hat_k2'   *U3_k1, U4hat_k2'*F4*U4_k1, B12starmatcT_k2'* kron(              U1star_k2'   *U1_k1, U2star_k2'*   U2_k1) * B12matcT_k1},[1,2,3])); %r1hatxr2hatxr34
        ...
        % % Plot 
        % % visualize solution at each timestep    
        %
        % figure(1)
        % surf(x, y, slice);
